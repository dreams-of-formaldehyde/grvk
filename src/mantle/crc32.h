...
//
// Based on Crc32.h, adapted to be compiled in C
//
...
uint32_t crc32_16bytes_prefetch(const void* data, size_t length, uint32_t previousCrc32, size_t prefetchAhead /* 256 */);
#endif
